...
public class ItemBuilder {
     ...
     * @since 1.0
     */
    public ItemBuilder(final Material itemType, final int amt, final byte dmg){
        item = new ItemStack(itemType, amt, dmg);
    ...
    public ItemBuilder lores(final String[] lores){
        ArrayList<String> loresList = new ArrayList<>(meta().getLore());
    ...
    public ItemBuilder clearEnchantment(final Enchantment enchantment){
        HashMap<Enchantment, Integer> itemEnchantments = new HashMap<>(make().getEnchantments());
